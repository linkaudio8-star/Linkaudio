...
const STATIC_ADMIN_TRANSLATIONS = [
  ...
  { selector: ".card-surface.p-8 .inline-flex.items-center.gap-2.rounded-full.bg-\\[\\#f5f6ff\\] span:nth-child(1)", en: "Overview", uk: "Огляд" },
  { selector: ".card-surface.p-8 .inline-flex.items-center.gap-2.rounded-full.bg-\\[\\#f5f6ff\\] span:nth-child(2)", en: "Trends", uk: "Тренди" },
