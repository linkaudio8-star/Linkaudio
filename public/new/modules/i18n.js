...
const TRANSLATIONS = {
  ...
  uk: {
    ...
    runtime: {
      ...
      toast_generate_first: "Спочатку згенеруйте звукове посилання.",
      toast_looping_stopped: "Циклічне відтворення зупинено.",
      toast_looping_started: "Циклічне відтворення запущено.",
      toast_playback_blocked: "Відтворення заблоковано — натисніть play в аудіоплеєрі.",
      toast_sound_deleted: "Звук видалено.",
      toast_signin_generate: "Увійдіть, щоб генерувати звукові посилання.",
      toast_audio_init_failed: "Не вдалося ініціалізувати аудіо. Перевірте доступ до мікрофона.",
      toast_audio_engine_failed: "Не вдалося завантажити аудіодвигун. Оновіть сторінку й спробуйте ще раз.",
      toast_audio_engine_loading: "Аудіодвигун ще завантажується. Спробуйте за мить.",
      toast_enter_text_before_generate: "Введіть текст або посилання перед генерацією.",
      toast_sound_ready: "Звукове посилання готове — натисніть play для прев’ю.",
      ...
      toast_press_play_audio: "Натисніть play в аудіоплеєрі, щоб прослухати.",
      toast_generate_before_download: "Згенеруйте звук перед завантаженням.",
      toast_generate_url_first: "Спочатку згенеруйте звукове посилання з URL.",
      ...
      toast_reload_audio_engine: "Не вдалося завантажити аудіодвигун. Перезавантажте сторінку й повторіть.",
      toast_audio_engine_wait: "Аудіодвигун ще завантажується. Будь ласка, зачекайте.",
      toast_mic_required: "Для сканування звукових посилань потрібен доступ до мікрофона.",
      toast_worklet_failed: "Не вдалося зареєструвати аудіо ворклет. Спробуйте ще раз.",
      ...
      toast_audio_ready: "Аудіодвигун готовий — можна починати сканування.",
      toast_audio_load_failed: "Не вдалося завантажити аудіодвигун. Оновіть сторінку, щоб повторити.",
      status_listening_links: "Слухаємо звукові посилання…",
      ...
      status_listening_with_time: "Слухаємо звукові посилання… залишилось {seconds}с",
      mode_ultrasound_toast: "Ультразвуковий режим активний для кодування.",
      scan_timeout_title: "Звукове посилання не виявлено",
      scan_timeout_hint: "Переконайтеся, що передавач відтворює тон AudioLink, і спробуйте ще раз.",
      scan_detected_title: "Звукове посилання виявлено!",
      scan_stop_listening: "Зупинити прослуховування",
      scan_listening_for_links: "Прослуховування звукових посилань",
      scan_countdown: "Залишилось {seconds}с",
      scan_keep_speaker_close: "Для кращого результату тримайте динамік у межах 1 метра. Для декодування використовується ультразвук.",
      ...
      history_loop_background: "Цикл у фоні",
      ...
      analytics_trend_hint: "Сканування по часових бакетах",
      analytics_not_available: "Н/Д",
...
const STATIC_INDEX_TRANSLATIONS = [
  ...
  { selector: "#scan-button-label", en: "Scan Now", uk: "Сканувати" },
  { selector: "#hero-login", en: "Login to Create", uk: "Увійти для створення" },
  { selector: "main > section:first-of-type p.inline-flex", en: "New Air-Link Experience", uk: "Новий Air-Link досвід" },
  { selector: "main > section:first-of-type h1", attr: "html", en: 'Scan the air for <span class="gradient-text">sound links</span>', uk: 'Скануйте простір на <span class="gradient-text">звукові посилання</span>' },
  { selector: "main > section:first-of-type p.text-lg", en: "Convert any digital link into immersive audio signals and decode them back with your microphone. The futuristic alternative to QR codes — no cameras required.", uk: "Перетворюйте будь-яке цифрове посилання на аудіосигнал і декодуйте його через мікрофон. Футуристична альтернатива QR-кодам — без камери." },
  ...
  { selector: "#last-decode-card p.text-xs", en: "Latest scan", uk: "Останній скан" },
  ...
  { selector: "main > section:first-of-type .rounded-2xl.border.border-white\\/60 p.text-sm.font-semibold.text-slate-600", en: "Recent Detection", uk: "Останнє виявлення" },
  ...
  { selector: "#how-it-works .grid > div:nth-child(1) h3", en: "Encode any link", uk: "Кодуйте будь-яке посилання" },
  { selector: "#how-it-works .grid > div:nth-child(1) p", en: "Paste your URL into AudioLink Studio and instantly transform it into a sonic signature ready for sharing.", uk: "Вставте URL в AudioLink Studio і миттєво перетворіть його на звуковий сигнал для поширення." },
  { selector: "#how-it-works .grid > div:nth-child(2) h3", en: "Broadcast or play", uk: "Транслюйте або відтворюйте" },
  { selector: "#how-it-works .grid > div:nth-child(2) p", en: "Play the audio over speakers or devices. It works in audible and ultrasonic ranges for flexible experiences.", uk: "Відтворюйте звук через колонки чи пристрої. Працює в чутному й ультразвуковому діапазонах." },
  { selector: "#how-it-works .grid > div:nth-child(3) h3", en: "Scan & decode", uk: "Скануйте та декодуйте" },
  { selector: "#how-it-works .grid > div:nth-child(3) p", en: "Tap “Scan now” and AudioLink will listen for the sound signature—decoded links appear instantly below.", uk: "Натисніть «Сканувати», і AudioLink почне слухати сигнал — декодовані посилання з’являться одразу." },
  { selector: "#preview h2", en: "Reimagined dashboard for your audio links", uk: "Оновлений дашборд для ваших аудіопосилань" },
  { selector: "#preview .space-y-6 > p", en: "Track scans, manage campaigns, and switch between audible and ultrasonic modes. The new dashboard brings clarity to every sonic interaction.", uk: "Відстежуйте сканування, керуйте кампаніями та перемикайтесь між чутним і ультразвуковим режимами. Новий дашборд робить кожну взаємодію прозорою." },
  ...
  { selector: "#preview .rounded-3xl h3", en: "Analytics arriving soon", uk: "Аналітика вже скоро" },
  { selector: "#preview .rounded-3xl p.mt-2", en: "Visualise scan performance, top campaigns, and live transmitter health directly in AudioLink Studio.", uk: "Візуалізуйте ефективність сканувань, топові кампанії та стан передавача прямо в AudioLink Studio." },
  { selector: "#pricing .section-heading", en: "Pricing", uk: "Ціни" },
  { selector: "#pricing .grid > div:nth-child(1) h3", en: "Starter", uk: "Starter" },
  { selector: "#pricing .grid > div:nth-child(1) p.mt-1", en: "For creators and early adopters", uk: "Для творців і ранніх користувачів" },
  ...
  { selector: "#pricing .grid > div:nth-child(2) p.mt-1", en: "For teams and businesses scaling experiences", uk: "Для команд і бізнесу, що масштабуються" },
  ...
  { selector: "#pricing .grid > div:nth-child(2) button", en: "Upgrade to Pro", uk: "Оновити до Pro" },
  { selector: "#pricing .grid > div:nth-child(3) h3", en: "Enterprise", uk: "Enterprise" },
  { selector: "#pricing .grid > div:nth-child(3) p.mt-1", en: "For embedded sonic systems", uk: "Для вбудованих sonic-систем" },
  { selector: "#pricing .grid > div:nth-child(3) li:nth-child(1)", en: "• On-prem deployment", uk: "• On-prem розгортання" },
  ...
  { selector: "#pricing .grid > div:nth-child(3) li:nth-child(4)", en: "• White-label experiences", uk: "• White-label сценарії" },
  { selector: "#pricing .grid > div:nth-child(3) .text-3xl.font-bold.text-slate-900", en: "Custom", uk: "Індивідуально" },
  { selector: "#pricing .grid > div:nth-child(3) a", en: "Contact sales", uk: "Зв’язатися з продажами" },
  ...
  { selector: "#about h2", en: "Designed for ambient experiences", uk: "Створено для ambient-досвіду" },
  { selector: "#about .text-base", en: "AudioLink lets brands build proximity-based experiences without relying on cameras or codes. Whether you're launching pop-up experiences, powering smart retail, or building playful connections, AudioLink adapts to your environment.", uk: "AudioLink допомагає брендам створювати proximity-сценарії без камер і кодів. Незалежно від того, запускаєте ви pop-up активацію, розвиваєте smart retail чи будуєте інтерактивні взаємодії — AudioLink адаптується до вашого середовища." },
  { selector: "#about .grid.sm\\:grid-cols-2 > div:nth-child(1) p.text-sm.font-semibold", en: "Offline ready", uk: "Готово до офлайну" },
  { selector: "#about .grid.sm\\:grid-cols-2 > div:nth-child(1) p.mt-2", en: "No connectivity? Your sonic links still work.", uk: "Немає інтернету? Ваші sonic-посилання все одно працюють." },
  ...
  { selector: "#about .rounded-2xl.border.border-white\\/60.bg-sound-surface li:nth-child(1)", en: "• Live events & conferences", uk: "• Live-події та конференції" },
  ...
  { selector: "#about .rounded-2xl.border.border-white\\/60.bg-sound-surface li:nth-child(3)", en: "• Smart retail & venues", uk: "• Smart retail і локації" },
  { selector: "#about .rounded-2xl.border.border-white\\/60.bg-sound-surface li:nth-child(4)", en: "• Private community drops", uk: "• Приватні ком’юніті-дропи" },
  { selector: "#about .rounded-2xl.border.border-white\\/60.bg-gradient-to-br p.text-base", en: "“AudioLink transforms the way we think about proximity experiences. It’s seamless, playful, and privacy-conscious.”", uk: "«AudioLink змінює підхід до proximity-досвіду. Це безшовно, захопливо й приватно.»" },
  ...
  { selector: "#login-overlay .text-center p.text-sm", en: "Create an account or sign in to manage your sound links.", uk: "Створіть акаунт або увійдіть, щоб керувати звуковими посиланнями." },
...
const STATIC_ADMIN_TRANSLATIONS = [
  ...
  { selector: "header .text-xs.text-slate-400", en: "Sonic link generation", uk: "Генерація sonic-посилань" },
  ...
  { selector: "[data-loop-label]", en: "Loop in background", uk: "Цикл у фоні" },
  { selector: "#analytics-tab-overview", en: "Overview", uk: "Огляд" },
  { selector: "#analytics-tab-trends", en: "Trends", uk: "Тренди" },
  { selector: "#analytics-link-scope-label", en: "Link scope", uk: "Область лінків" },
  { selector: "#analytics-link-scope option[value='all']", en: "All links", uk: "Усі лінки" },
  { selector: "#analytics-link-scope option[value='selected']", en: "Selected link", uk: "Вибраний лінк" },
  ...
  { selector: "#analytics-top-title", en: "Top links", uk: "Топ лінки" },
  { selector: "#analytics-top-hint", en: "By scans", uk: "За скануваннями" },
  { selector: "#analytics-top-empty", en: "No links with scans yet.", uk: "Ще немає лінків зі скануваннями." },
  { selector: "#analytics-top-error", en: "Failed to load top links.", uk: "Не вдалося завантажити топ лінки." },
  { selector: "#analytics-top-col-link", en: "Link", uk: "Лінк" },
  ...
  { selector: ".card-surface.p-6 .text-xs.font-semibold.uppercase.tracking-wide.text-slate-400", en: "Recent Sound Links", uk: "Останні звукові посилання" },
  ...
  { selector: ".card-surface.p-8:nth-of-type(2) h2", en: "Monitor your sonic traffic", uk: "Відстежуйте ваш sonic-трафік" },
  ...
  { selector: "#encode-history-empty", en: "Generated sound links will appear here with quick controls.", uk: "Тут з’являтимуться згенеровані звукові посилання зі швидким керуванням." },
  ...
  { selector: "#scan-overlay .text-center h3", en: "Listening for sound links", uk: "Прослуховування звукових посилань" },
  ...
  { selector: "#scan-state-scanning p.rounded-2xl", en: "Keep your speaker within 1 meter for best results. Ultrasound mode is used for decoding.", uk: "Для кращого результату тримайте динамік у межах 1 метра. Для декодування використовується ультразвук." },
  { selector: "#scan-state-success .font-semibold", en: "Sound link detected!", uk: "Звукове посилання виявлено!" },
  { selector: "#scan-state-timeout .font-semibold", en: "No sound link detected", uk: "Звукове посилання не виявлено" },
